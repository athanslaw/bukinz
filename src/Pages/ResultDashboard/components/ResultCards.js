...
const ResultCards = ({data}) => {
    return (
        <div>
            ...
            <div className="flex justify-between items-center py-2 shadow-container px-2.5">
                <div className="bg-oceanBlue py-2 text-center rounded-xsm .shadow-container w-118">
